...
<div id="content">
	...
	<div id="sobre-texto">
		<h2 style="text-align:center;">Calendário de Ensaios e Eventos do Instituto <img style="height:30px; padding-left:10px;padding-top:10px;"src="../assets/kineret_escrito.png"></img></h2>
		<h6 class="sobre-t"><iframe src="gcalendar-wrapper.php?showTitle=0&amp;showDate=1&amp;showPrint=0&amp;showTabs=0&amp;showCalendars=0&amp;showTz=0&amp;height=600&amp;wkst=1&amp;hl=pt_BR&amp;bgcolor=%23FFFFFF&amp;src=89bug1tmi7liui5jl081vvq65s%40group.calendar.google.com&amp;color=%23182C57&amp;ctz=America%2FSao_Paulo" style="-moz-border-radius: 10px;border-radius: 10px;" width="800" height="600" frameborder="0" scrolling="no"></iframe>
	</div>
